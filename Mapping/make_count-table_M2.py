...
#sbatch --export=All -t 24:00:00 --mem=100G  -e run_log/2-ct.err -o run_log/2-ct.out -J 2-ct --wrap="python make_count-table_allMuscles.py"
...
id_files=['TM4-21', 'TM4-22', 'TM4-23', 'TM4-24', 'TM4-35', 'TM4-36', 'TM4-37', 'TM4-38', 'TM4-49', 'TM4-50', 'TM4-51', 'TM4-52']
files_cpg=[]
labels_cpg=[]
...
for label in data_cpg:
    if count == 0:
        data_all['Muscle_2']=data_cpg[label]
        count=1
    else:
        data_all['Muscle_2']= pd.concat([data_all['Muscle_2'], data_cpg[label]], axis=1).dropna()
