...
#sbatch --export=All -t 24:00:00 --mem=100G  -e run_log/all-ct.err -o run_log/all-ct.out -J all-ct --wrap="python make_count-table_noBins_bed.py"
...
id_files=['M3-4', 'M3-5', 'M3-6', 'M3-7', 'M3-21', 'M3-22', 'M3-23', 'M3-24', 'M3-37', 'M3-38', 'M3-39', 'M3-40',
        'TM4-21', 'TM4-22', 'TM4-23', 'TM4-24', 'TM4-35', 'TM4-36', 'TM4-37', 'TM4-38', 'TM4-49', 'TM4-50', 'TM4-51', 'TM4-52',
        'TM6-13', 'TM6-14', 'TM6-15', 'TM6-16', 'TM6-27', 'TM6-28', 'TM6-29', 'TM6-30', 'TM6-38', 'TM6-39', 'TM6-40', 'TM6-41']
files_cpg=[]
labels_cpg=[]
...
for label in data_cpg:
    if count == 0:
        data_all['shared']=data_cpg[label]
        count=1
    else:
        data_all['shared']= pd.concat([data_all['shared'], data_cpg[label]], axis=1).dropna()
