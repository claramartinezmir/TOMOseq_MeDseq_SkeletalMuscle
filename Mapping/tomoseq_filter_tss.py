...
#sbatch --export=All -t 48:00:00 --mem=100G -e run_log/filter_TSS3kb.err -o run_log/filter_TSS3kb.out -J filter_TSS3kb --wrap="python tomoseq_filter_tss.py TM6_1000bp200ovl TM4_1000bp200ovl M3_1000bp200ovl"
...
for key in id_files:
    ...
    #create new file
    fout = open(path + key + '_cpg_coverage_table_TSS3kb_TOMOseqfilter'+ str(thr)+'.bed','w')
    #open file
    with open(path + key + '_cpg_coverage_table_TSS3kb.bed') as f:
